            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <button class="btn btn-info">Tambah</button><br><br>
                                <table class="table table-striped">
                                        <tr>
                                            <th>Panel LVMDV</th>
                                            <th><button class="btn btn-info">MODBUS</button></th>
                                            <th><button class="btn btn-info">SNMP</button></th>
                                        </tr>
...
<!-- end ip read -->
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <button class="btn btn-info"><a href="aksi.php">Reboot</button>
